	...
	public void setEndFinancialyear(String endFinancialyear) {
		EndFinancialyear = endFinancialyear;
			...
			public String execute() {
				...
				System.out.println("Sql..........."+compId);
			// new connectionClass();
			// Connection con1 = connectionclass.getConnection();
			Connection con1=new connectionclass().getConnection();
			
			String query = "UPDATE company_master SET Company=?, Contact1=?, Contact2=?,Address=?, Country=?, State=?, City=?, Postalcode=?, EmailId=?, CompanyWebsite=?, RegistrationNo=?, Bankname=?, GSTno=?, Accountno=?, PANno=?, IFSCcode=?, StartFinancialyear=?, EndFinancialyear=? WHERE id='"+compId+"'";
