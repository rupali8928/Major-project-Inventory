...
public class insertemployee extends ActionSupport {
	...
	public String execute() {
		System.out.println("in execute employee....");
	...
	String query = "INSERT INTO employee (`FirstName`, `LastName`,`Address`, `State`, `City`, `Postalcode`, `DOB`, `Emailid`, `Mobile1`, `Mobile2`,`Position`, `Salary`)VALUES(?, ?, ?, ?,?, ?, ?, ?, ?, ?, ?,?)";
	try  {
