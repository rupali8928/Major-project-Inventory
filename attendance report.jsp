                ...
                <div class="animated fadeIn">
                    ...
                    <div class="col-lg-12">
                         <div class="card border border-secondary ">
                            <div class="card-header"><strong>Customer Information</strong><strong> Form</strong>
                                        ...
                                        <tbody>
                                         <%
                                            ...
                                            <tr>
                                                                                                ...
                                                                                                <td id="FirstName_<%rs.getString("id");%>"><%=rs.getString("FirstName") %></td>
                                                                                                <td id="LastName_<%rs.getString("id");%>"><%=rs.getString("LastName") %></td>
                                                                                                <td id="Mobile1_<%rs.getString("id");%>"><%=rs.getString("Mobile1") %></td>
                                                                                                
                                                                                                <td id="Address1_<%rs.getString("id");%>"><%=rs.getString("Address1") %></td>
                                        ...
                                        <tbody>
                                         <%
                                            ...
                                            <tr>
   																									 ...
   																									 <td><%=i%><input type="hidden" id="id" value="<%rs.getString("id");%>"> </td>                         
                                                                                                <td id="employee_<%rs.getString("id");%>"><%=rs.getString("employee") %></td>
